...
async function processCompletedSession(sessionData) {
    ...
    const seedType = sessionData.seedType || 'Padrão';

    // Garante que o inventário de sementes para o tipo exista
    ...
    createNotification(`Ciclo Concluído!`, `Você ganhou 1 Semente de ${seedType} 🌱.`);
}
