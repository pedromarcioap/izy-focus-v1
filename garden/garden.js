document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadData() {
        if (typeof chrome !== 'undefined' && chrome.storage && chrome.storage.local) {
            ...
            gardenData.layout = [];
            gardenData.inventory = { seeds: { 'Padrão': 5 }, stones: 3 }; // Add some mock data for verification
        }
    }
    ...
    function createGardenItemElement(itemData) {
        ...
        if (itemData.type === 'plant') {
            ...
            if (itemData.withered) {
                ...
                itemElement.style.backgroundImage = `url('../assets/icons/${itemData.seedType || 'Padrao'}_plant_stage${stage}.png')`;
            }
